...
export function FulfillmentPage() {
  ...
  const toggleAll = () => {
    if (selectedOrders.size === ordersQueue.length) {
      setSelectedOrders(new Set());
    } else {
      setSelectedOrders(new Set(ordersQueue.map(o => o.id)));
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-[#1a1a1a] border border-[#262626] rounded-lg p-6">
          ...
          <p className="text-3xl text-[#f5f5f5]">{ordersQueue.length}</p>
        </div>
        <div className="bg-[#1a1a1a] border border-[#262626] rounded-lg p-6">
          <div className="flex items-center gap-3 mb-2">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <label className="flex items-center gap-2 text-sm text-[#a3a3a3]">
              <input
                type="checkbox"
                checked={selectedOrders.size === ordersQueue.length && ordersQueue.length > 0}
                onChange={toggleAll}
          ...
          {selectedOrders.size > 0 && (
            <div className="flex items-center gap-3">
              <button className="px-4 py-2 bg-[#4A7C2C] text-white rounded-lg hover:bg-[#3d6624] transition-colors flex items-center gap-2">
                <Printer className="w-4 h-4" />
                Bulk Print Labels ({selectedOrders.size})
              </button>
              <button className="px-4 py-2 bg-[#A68A64] text-[#0a0a0a] rounded-lg hover:bg-[#8f7556] transition-colors flex items-center gap-2">
          ...
          <div className="bg-[#1a1a1a] border border-[#262626] rounded-lg max-w-2xl w-full max-h-[90vh] overflow-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex gap-3 pt-4">
                <button className="flex-1 px-6 py-3 bg-[#4A7C2C] text-white rounded-lg hover:bg-[#3d6624] transition-colors flex items-center justify-center gap-2">
                  <Printer className="w-5 h-5" />
                  Print Label
                </button>
                <button className="flex-1 px-6 py-3 bg-[#A68A64] text-[#0a0a0a] rounded-lg hover:bg-[#8f7556] transition-colors flex items-center justify-center gap-2">
