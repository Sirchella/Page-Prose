            ...
            <tbody>
              {filteredBooks.map((book) => (
                <tr key={book.id} className="border-b border-[#262626] hover:bg-[#1a1a1a]/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-[#f5f5f5]">${book.price.toFixed(2)}</td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <button className="p-2 text-[#a3a3a3] hover:text-[#A68A64] hover:bg-[#262626] rounded transition-colors">
                        <Edit className="w-4 h-4" />
                      </button>
                      <button className="p-2 text-[#a3a3a3] hover:text-[#dc2626] hover:bg-[#262626] rounded transition-colors">
