          ...
          <div className="flex gap-4 items-start">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-3 items-end">
                ...
                <button onClick={() => alert('Tracking page coming soon.')} className="bg-[#4a7c2c] text-white text-[16px] leading-[24px] font-semibold px-6 py-3 rounded-[10px] hover:bg-[#3a621c] transition-colors">
                  Track Order
                </button>
              </div>
            </div>
