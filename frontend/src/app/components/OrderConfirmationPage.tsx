  ...
  return (
    <div className="min-h-screen bg-[#F5EFE7]">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-8 md:py-16">
            ...
            <div className="mt-6 pt-6 border-t-2 border-[#E8DCC8]">
              <div className="flex justify-between items-center">
                ...
                <span className="text-2xl text-[#4A7C2C] font-serif">
                  {Math.round(totalAmount).toLocaleString()} XAF
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <div className="flex-1 px-4 py-3 bg-[#F5EFE7] border border-[#E8DCC8] rounded-lg">
                  ...
                  <div className="text-sm text-[#2C2416] font-mono break-all">{trackingNumber}</div>
                </div>
                <button onClick={() => alert('Tracking page coming soon.')} className="px-6 py-3 bg-[#4A7C2C] text-white rounded-lg hover:bg-[#3d6624] transition-colors font-semibold whitespace-nowrap">
                  Track Order
                </button>
              </div>
            </div>
        ...
        <div>
          <h2 className="text-xl md:text-2xl text-[#2C2416] font-serif mb-4 md:mb-6 text-center">
            You May Also Like
          </h2>
